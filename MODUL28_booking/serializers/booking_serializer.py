...
# class BookingDelRequest(BaseModel):
#     Cookie: str = Field(..., description='Sets an authorization token to access the DELETE endpoint')
#     Authorization: str = Field(..., description='Basic authorization header to access the DELETE endpoint')
#
#
# class BookingDelResponse(BaseModel):
#     http: str = Field(..., description='some responce')